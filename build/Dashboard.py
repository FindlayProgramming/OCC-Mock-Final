...
def callback_page(url):
    webbrowser.open_new(r'C:\\Users\\findl\\OneDrive\\Documents\\Github\\OCC-Mock\\build\\Home-Page.py') #Will open the home-page file, will be relevant when clicking the buttons available. Make sure to change this path!!!
...
button_1 = Button( #Creates a button.
    ...
    borderwidth=0,
    highlightthickness=0,
    command=lambda: callback_page (r'C:\\Users\\findl\\OneDrive\\Documents\\Github\\OCC-Mock\\build\\Home-Page.py'), #This line means that if a the button is clicked it will direct to the other python file "Home-Page". Make sure to change this path!!!
    relief="flat"
)
...
button_3 = Button(
    ...
    borderwidth=0,
    highlightthickness=0,
    command=lambda: callback_page (r'C:\\Users\\findl\\OneDrive\\Documents\\Github\\OCC-Mock\\build\\Home-Page.py'), #Make sure to change this path!!!
    relief="flat"
)
button_3.place(
    x=17.0,
